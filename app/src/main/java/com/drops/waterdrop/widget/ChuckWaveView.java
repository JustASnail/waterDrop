...
public class ChuckWaveView extends View {
    ...
    private void createShader() {
        ...
        wavePaint.setColor(Color.parseColor("#FF41C8FF")); //前面的波浪
    ...
    public void start() {
        ...
        ObjectAnimator waveShiftAnim = ObjectAnimator.ofFloat(this, "waveShiftRatio", 0f, 1f); //水平方向循环
        waveShiftAnim.setRepeatCount(ValueAnimator.INFINITE);
        waveShiftAnim.setDuration(2000);
        waveShiftAnim.setInterpolator(new LinearInterpolator());
        mAnimators.add(waveShiftAnim);
        ObjectAnimator waterLevelAnim = ObjectAnimator.ofFloat(this, "waterLevelRatio", 0.14f, 0.15f); //竖直方向从0%到x%
