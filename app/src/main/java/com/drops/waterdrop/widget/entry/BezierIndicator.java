package com.drops.waterdrop.widget.entry;
...
public class BezierIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    private void init() {
        ...
        roundColors[0] = getResources().getColor(com.drops.waterdrop.R.color.color_guide1);
        roundColors[1] = getResources().getColor(com.drops.waterdrop.R.color.color_guide2);
        roundColors[2] = getResources().getColor(com.drops.waterdrop.R.color.color_guide3);
...
//        mBitmaps[0] = BitmapFactory.decodeResource(getResources(), com.mydemo.statusdemo.R.drawable.camera);
//        mBitmaps[1] = BitmapFactory.decodeResource(getResources(), com.mydemo.statusdemo.R.drawable.msg);
//        mBitmaps[2] = BitmapFactory.decodeResource(getResources(), com.mydemo.statusdemo.R.drawable.notice);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        M = (int) (R * C);
        span = 40;
        int i1 = getWidth() - (R * 6 + span * 2);
        mStartPoint = new Point(i1 / 2, h / 2);
...
//        drawBitmap(canvas);
    ...
    private void drawCircleBg(Canvas canvas) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            mCircleBgPaint.setColor(Color.parseColor("#e6e6e6"));
