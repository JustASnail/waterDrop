...
public class MessageHelper {
    ...
    public static String getVerifyNotificationText(SystemMessage message, Button btnAgree) {
        ...
        if (message.getType() == SystemMessageType.TeamInvite) {
            ...
            if (attachData != null) {
                if (attachData.getEvent() == AddFriendNotify.Event.RECV_ADD_FRIEND_DIRECT) {
                    ...
                    if (message.getStatus().getValue() == 1) {
                        btnAgree.setText("已同意");
                        btnAgree.setEnabled(false);
                    } else if (message.getStatus().getValue() == 2) {
