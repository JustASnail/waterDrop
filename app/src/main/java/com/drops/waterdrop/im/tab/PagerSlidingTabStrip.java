...
import com.drops.waterdrop.im.reminder.ReminderSettings;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    // @formatter:on 621 226 10010 75149218
...
//                textView.setTextColor(getResources().getColor(unCheckedTextColor));
    ...
    private void addTabView(final int position, String title) {
        ...
        if (tabView == null) {
            tabView = inflater.inflate(R.layout.tab_layout_main_message, null);
        }
        ...
        if (titleTV != null) {
            titleTV.setTextSize(TypedValue.COMPLEX_UNIT_PX, needAdaptation ? resources.getDimensionPixelSize(R.dimen.text_size_10) : resources.getDimensionPixelSize(R.dimen.text_size_12));
    ...
    private void addTab(final int position, View tab) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position == 0 && mFirstTabClickListener != null && !MyUserCache.getGuide()) {
                    mFirstTabClickListener.onClickListener();
                }
            }
        });
    ...
    public interface OnFirstTabClickListener{

        void onClickListener();
    }

    private OnFirstTabClickListener mFirstTabClickListener;

    public void setFirstTabClickListener(OnFirstTabClickListener firstTabClickListener) {
        mFirstTabClickListener = firstTabClickListener;
    }
