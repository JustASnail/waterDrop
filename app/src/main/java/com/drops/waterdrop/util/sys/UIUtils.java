...
public class UIUtils {
    ...
    public static Handler getMainThreadHandler() {
        return WaterDropApp.getMainHandler();
    }
    ...
    public static long getMainThreadId() {
        return WaterDropApp.getMainThreadId();
    }
    ...
    public static String stringFormat(@StringRes int rid, Object... args){
        return stringFormat(getString(rid), args);
    }
