...
import com.drops.waterdrop.ui.session.adapter.BalanceMsgListAdapter;
...
public class BalanceMessageListActivity extends BaseActivity {


    @Bind(R.id.recycler_view)
    RecyclerView mRecyclerView;
    private BalanceMsgListAdapter mAdapter;

    public static void start(Context context) {
        Intent starter = new Intent(context, BalanceMessageListActivity.class);
    ...
    protected void initView() {
        ...
        options.titleString = "余额账户变动";
        setMyToolbar(options);

        mAdapter = new BalanceMsgListAdapter(0);
    ...
    protected void initData() {
        ...
        List<SystemMessageDB> jinDouList = dbDao.queryBuilder().where(SystemMessageDBDao.Properties.Type.eq(61)).list();
            ...
            mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                ...
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    if (!FastClickUtil.isFastDoubleClick()) {
                        ...
                        MineBankActivity.start(BalanceMessageListActivity.this);
    ...
    public void onSystemMessageEvent(BalanceMsgEvent event) {
        SystemMessageDBDao dbDao = GreenDaoManager.getInstance().getmDaoSession().getSystemMessageDBDao();
        List<SystemMessageDB> jinDouList = dbDao.queryBuilder().where(SystemMessageDBDao.Properties.Type.eq(61)).list();//金豆
