...
public class StarListActivity extends BaseActivity<IStarListView, StarListPresenter> implements IStarListView, BaseQuickAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, StarListActivity.class);
...
//        initErrorPager();
    ...
    protected StarListPresenter createPresenter() {
        return new StarListPresenter(this);
    }
