...
public class JinDouMsgListAdapter extends BaseQuickAdapter<SystemMessageDB, BaseViewHolder> {
    public JinDouMsgListAdapter(@LayoutRes int layoutResId) {
        super(R.layout.item_jin_dou_msg);
    }
