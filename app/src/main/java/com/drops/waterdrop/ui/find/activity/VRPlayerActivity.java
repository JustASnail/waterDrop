...
import com.drops.waterdrop.ui.find.VideoController;
...
public class VRPlayerActivity extends Activity implements UVPlayerCallBack, VideoController.PlayerControl {
    ...
    public static void start(Context context, String url) {
        Intent starter = new Intent(context, VRPlayerActivity.class);
        starter.putExtra(Constants.EXTRA_VIDEO_URL, url);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMediaplayer = new UVMediaPlayer(VRPlayerActivity.this, rlPlayView);
...
//        mMediaplayer.setGyroEnabled(true);
    ...
    private void parseIntent() {
        if (getIntent() != null) {
            Path = getIntent().getStringExtra(Constants.EXTRA_VIDEO_URL);
        }
        if (TextUtils.isEmpty(Path)) {
            Path = "http://cache.utovr.com/201508270528174780.m3u8";
        }
    }
...
//                        Utils.setBufferVisibility(imgBuffer, true);
                ...
                case UVMediaPlayer.STATE_READY:
                    ...
                    if (!mMediaplayer.isGyroEnabled()) {
                        mCtrl.setGyroEnabledboolean(true);
                    }
