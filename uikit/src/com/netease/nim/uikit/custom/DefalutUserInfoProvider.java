...
public class DefalutUserInfoProvider implements UserInfoProvider {
    ...
    public Bitmap getAvatarForMessageNotifier(String account) {
        ...
        Bitmap bitmap = ImageLoaderKit.getNotificationBitmapFromCache(user.getAvatar());
        if (bitmap == null && user != null) {
            return ImageLoader.getInstance().loadImageSync(user.getAvatar());
        }
        return (user != null) ? bitmap : null;
    }
    ...
    public Bitmap getTeamIcon(String teamId) {
        ...
        // 默认图
        Drawable drawable = context.getResources().getDrawable(R.drawable.img_qs_50x50);
