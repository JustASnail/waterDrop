...
import com.netease.nim.uikit.common.media.picker.activity.PickerQRCodeImgActivity;
...
public class PickerPreviewPagerAdapter extends PagerAdapter{
    ...
    public void setPrimaryItem (View container, int position, Object object) {
		if (mActivity instanceof PickerAlbumPreviewActivity) {
		((PickerAlbumPreviewActivity) mActivity).updateCurrentImageView(position);
		} else if (mActivity instanceof PickerQRCodeImgActivity) {
			((PickerQRCodeImgActivity) mActivity).updateCurrentImageView(position);
		}
	}
}
