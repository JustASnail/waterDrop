...
public class PickerAlbumActivity extends UI implements OnAlbumItemClickListener,
	...
	private boolean isScanImgMode = false;
	...
	private void proceedExtra(){
		...
		if(intent != null){
			...
			isScanImgMode = intent.getBooleanExtra(Extras.EXTRA_IS_SCAN_MODE, false);
	...
	public void onPhotoSingleClick(List<PhotoInfo> photos, int position) {
		if (isScanImgMode) {
			PickerQRCodeImgActivity.start(this, photos, position, hasSelectList, mutiSelectLimitSize);
			return;
		}
