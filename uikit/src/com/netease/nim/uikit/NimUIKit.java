...
public final class NimUIKit {
    ...
    // 自定义系统消息消息列表一些点击事件的响应处理函数
    private static SystemMessageEventListener systemMessageListener;

    // 群资料群成员列表点击事件
    private static TeamMemberItemClickListener teamMemberItemClickListener;

    // 聊天页面图片点击事件
    private static SessionImgItemClickListener sessionImgItemClickListener;

    //聊天页面web超链接点击事件
    private static SessionAutoLinkClickListener sessionAutoLinkClickListener;
     ...
     * @return
     */
    public static SystemMessageEventListener getSystemMessageListener() {
     ...
     * 设置系统消息列表的事件监听器
     *
     * @param systemMessageListener
     */
    public static void setSystemMessageListener(SystemMessageEventListener systemMessageListener) {
        NimUIKit.systemMessageListener = systemMessageListener;
    }
     ...
     * @return
     */
    public static TeamMemberItemClickListener getTeamMemberClickListener() {
        return teamMemberItemClickListener;
    }

    /**
     * 设置系统消息列表的事件监听器
     *
     * @param teamMemberItemClickListener
     */
    public static void setTeamMemberClickListener(TeamMemberItemClickListener teamMemberItemClickListener) {
        NimUIKit.teamMemberItemClickListener = teamMemberItemClickListener;
    }
     ...
     * @return
     */
    public static SessionImgItemClickListener getSessionImgItemClickListener() {
        return sessionImgItemClickListener;
    }

    /**
     * 设置聊天页面图片的事件监听器
     *
     * @param sessionImgItemClickListener
     */
    public static void setSessionImgItemClickListener(SessionImgItemClickListener sessionImgItemClickListener) {
        NimUIKit.sessionImgItemClickListener = sessionImgItemClickListener;
    }

    /**
     * 设置系统消息列表的事件监听器
     *
     * @param sessionAutoLinkClickListener
     */
    public static void setSessionAutoLinkClickListener(SessionAutoLinkClickListener sessionAutoLinkClickListener) {
        NimUIKit.sessionAutoLinkClickListener = sessionAutoLinkClickListener;
    }
     ...
     * @return
     */
    public static SessionAutoLinkClickListener getSessionAutoLinkClickListener() {
        return sessionAutoLinkClickListener;
    }
