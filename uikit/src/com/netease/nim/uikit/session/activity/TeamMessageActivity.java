...
public class TeamMessageActivity extends BaseMessageActivity {
    ...
    private void updateTeamInfo(final Team d) {
        ...
        if (mTitle != null) {
            mTitle.setText(team == null ? sessionId : team.getName() + "(" + team.getMemberCount() + "人)");
        }
        ...
        mIvRight.setVisibility(team.isMyTeam() ? View.VISIBLE : View.GONE);
    }
    ...
    protected void initToolBar() {
        ...
        mIvRight.setImageResource(R.drawable.icon_grxx_strs);
